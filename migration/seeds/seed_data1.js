exports.seed = async function(knex) {
  ...
  await knex('Category').insert([
    { CategoryID: 1, Name: 'Uncategorized', Description: 'Uncategorized shoes' },
    { CategoryID: 2, Name: 'Men', Description: 'Men\'s shoes' },
    { CategoryID: 3, Name: 'Women', Description: 'Women\'s shoes' },
    { CategoryID: 4, Name: 'Sports', Description: 'Sports shoes' }
]);
  ...
  await knex('Shoes').insert([
    { ShoesID: 1, CategoryID: 2, Name: 'Nike Air Max', Brand: 'Nike', Size: '10', Color: 'Black', Cost: 100.00, Price: 120.00, Stock: 50, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196148/adidas3_yls1aa.jpg', Description: 'Comfortable and stylish Nike Air Max shoes.', Status: 'Active' },
    { ShoesID: 2, CategoryID: 3, Name: 'Adidas Ultraboost', Brand: 'Adidas', Size: '8', Color: 'White', Cost: 120.00, Price: 150.00, Stock: 30, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196148/adidas5_uliobk.jpg', Description: 'High-performance Adidas Ultraboost running shoes.', Status: 'Active' },
    { ShoesID: 3, CategoryID: 4, Name: 'Puma Running', Brand: 'Puma', Size: '9', Color: 'Blue', Cost: 80.00, Price: 100.00, Stock: 20, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196148/adidas4_x0go0s.jpg', Description: 'Lightweight and durable Puma running shoes.', Status: 'Active' },
    { ShoesID: 4, CategoryID: 2, Name: 'Reebok Classic', Brand: 'Reebok', Size: '11', Color: 'Red', Cost: 90.00, Price: 110.00, Stock: 40, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/adidas1_tbkhwo.jpg', Description: 'Classic Reebok shoes with a retro design.', Status: 'Active' },
    { ShoesID: 5, CategoryID: 3, Name: 'New Balance 574', Brand: 'New Balance', Size: '7', Color: 'Green', Cost: 110.00, Price: 130.00, Stock: 25, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/converse1_tnygsh.jpg', Description: 'Versatile and comfortable New Balance 574 shoes.', Status: 'Active' },
    { ShoesID: 6, CategoryID: 4, Name: 'Asics Gel-Kayano', Brand: 'Asics', Size: '9', Color: 'Yellow', Cost: 120.00, Price: 140.00, Stock: 35, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196146/nike4_wwbkfs.jpg', Description: 'Supportive and cushioned Asics Gel-Kayano shoes.', Status: 'Active' },
    { ShoesID: 7, CategoryID: 2, Name: 'Converse All Star', Brand: 'Converse', Size: '10', Color: 'Black', Cost: 50.00, Price: 60.00, Stock: 60, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/converse2_popcku.jpg', Description: 'Iconic Converse All Star shoes with a timeless design.', Status: 'Active' },
    { ShoesID: 8, CategoryID: 3, Name: 'Vans Old Skool', Brand: 'Vans', Size: '8', Color: 'White', Cost: 60.00, Price: 70.00, Stock: 45, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/nike3_fchusm.jpg', Description: 'Classic Vans Old Skool shoes with a retro design.', Status: 'Active' },
    { ShoesID: 9, CategoryID: 4, Name: 'Under Armour HOVR', Brand: 'Under Armour', Size: '9', Color: 'Blue', Cost: 130.00, Price: 150.00, Stock: 20, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/converse5_tp0p8j.jpg', Description: 'High-performance Under Armour HOVR running shoes.', Status: 'Active' },
    { ShoesID: 10, CategoryID: 2, Name: 'Jordan Air', Brand: 'Nike', Size: '11', Color: 'Red', Cost: 180.00, Price: 200.00, Stock: 30, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/nike3_fchusm.jpg', Description: 'Premium Jordan Air shoes with superior comfort.', Status: 'Active' },
    { ShoesID: 11, CategoryID: 3, Name: 'Fila Disruptor', Brand: 'Fila', Size: '7', Color: 'Pink', Cost: 70.00, Price: 90.00, Stock: 50, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/converse4_eqyc6x.jpg', Description: 'Chunky and stylish Fila Disruptor shoes.', Status: 'Active' },
    { ShoesID: 12, CategoryID: 4, Name: 'Brooks Ghost', Brand: 'Brooks', Size: '9', Color: 'Grey', Cost: 110.00, Price: 130.00, Stock: 25, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/nike1_v2vfy2.jpg', Description: 'Comfortable and supportive Brooks Ghost running shoes.', Status: 'Active' },
    { ShoesID: 13, CategoryID: 2, Name: 'Saucony Jazz', Brand: 'Saucony', Size: '10', Color: 'Blue', Cost: 70.00, Price: 80.00, Stock: 40, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196146/nike4_wwbkfs.jpg', Description: 'Classic Saucony Jazz shoes with a retro design.', Status: 'Active' },
    { ShoesID: 14, CategoryID: 2, Name: 'Nike ZoomX', Brand: 'Nike', Size: '9', Color: 'Green', Cost: 160.00, Price: 180.00, Stock: 20, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/converse5_tp0p8j.jpg', Description: 'High-performance Nike ZoomX shoes for running.', Status: 'Active' },
    { ShoesID: 15, CategoryID: 3, Name: 'Adidas NMD_R1', Brand: 'Adidas', Size: '10', Color: 'Black', Cost: 140.00, Price: 160.00, Stock: 35, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/nike1_v2vfy2.jpg', Description: 'Modern Adidas NMD_R1 sneakers with Boost technology.', Status: 'Active' },
    { ShoesID: 16, CategoryID: 4, Name: 'Puma Ignite', Brand: 'Puma', Size: '8', Color: 'Orange', Cost: 120.00, Price: 140.00, Stock: 25, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196148/adidas5_uliobk.jpg', Description: 'Responsive and stylish Puma Ignite shoes for running.', Status: 'Active' },
    { ShoesID: 17, CategoryID: 2, Name: 'Reebok Nano X', Brand: 'Reebok', Size: '11', Color: 'White', Cost: 100.00, Price: 120.00, Stock: 50, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/nike3_fchusm.jpg', Description: 'Reebok Nano X shoes for cross-training and fitness.', Status: 'Active' },
    { ShoesID: 18, CategoryID: 3, Name: 'New Balance Fresh Foam', Brand: 'New Balance', Size: '7', Color: 'Yellow', Cost: 120.00, Price: 140.00, Stock: 30, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196148/adidas5_uliobk.jpg', Description: 'New Balance Fresh Foam shoes for ultimate comfort.', Status: 'Active' },
    { ShoesID: 19, CategoryID: 4, Name: 'Asics Metaspeed', Brand: 'Asics', Size: '9', Color: 'Blue', Cost: 180.00, Price: 200.00, Stock: 15, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/converse2_popcku.jpg', Description: 'Asics Metaspeed racing shoes for professional runners.', Status: 'Active' },
    { ShoesID: 20, CategoryID: 2, Name: 'Jordan Delta', Brand: 'Nike', Size: '12', Color: 'Black', Cost: 150.00, Price: 170.00, Stock: 40, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196146/nike4_wwbkfs.jpg', Description: 'Stylish and versatile Jordan Delta shoes for casual wear.', Status: 'Active' },
    { ShoesID: 21, CategoryID: 3, Name: 'Adidas Supernova', Brand: 'Adidas', Size: '9', Color: 'Pink', Cost: 110.00, Price: 130.00, Stock: 20, Image: 'https://res.cloudinary.com/dyocg3k6j/image/upload/v1732196147/adidas1_tbkhwo.jpg', Description: 'Adidas Supernova shoes for long-distance running.', Status: 'Active' },
  ]);
